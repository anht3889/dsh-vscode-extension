/**
 * Browser-safe `@file` token grammar for the composer webview.
 *
 * Behavior copied from `deepseek-harness/packages/context/file-reference/src/grammar.ts`;
 * tests intentionally lock parity with that harness source.
 *
 * @module dsh-vscode/fileMention
 */
